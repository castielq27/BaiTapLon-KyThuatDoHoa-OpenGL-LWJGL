...
public class tivi {
    ...
    public tivi(int vao ){
        ...
        this.vertexShader("opengl/test/object/tivi/tivi.vs");
        this.fragmentShader("opengl/test/object/tivi/tivi.fs");
        this.link();
        this.initVertex();
    ...
    private void vertexShader(String file){
        ...
        GL20.glShaderSource(this.vertexID, tivi.sourceLoader(file));
    ...
    private void fragmentShader(String file){
        ...
        GL20.glShaderSource(this.fragmentID, tivi.sourceLoader(file));
    ...
    private static String sourceLoader(String file){
        Scanner in = new Scanner( tivi.class.getClassLoader().getResourceAsStream(file));
