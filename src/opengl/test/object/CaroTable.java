...
public class CaroTable {
    ...
    public CaroTable(int vao){
        ...
        this.vertexShader("opengl/test/object/CaroTable.vs");
        this.fragmentShader("opengl/test/object/CaroTable.fs");
        this.link();
        this.initVertex();
    ...
    private void vertexShader(String file){
        ...
        GL20.glShaderSource(this.vertexID, CaroTable.sourceLoader(file));
    ...
    private void fragmentShader(String file){
        ...
        GL20.glShaderSource(this.fragmentID, CaroTable.sourceLoader(file));
    ...
    private void initVertex(){
        ...
        float[] data = new float[]{    -0.5f, -0.5f, 0f, 1f, 1f, 1f, 0f, 0f,
