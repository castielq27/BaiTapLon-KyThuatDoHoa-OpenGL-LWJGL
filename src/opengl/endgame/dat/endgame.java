...
public class endgame {
    ...
    public endgame(int vao ){
        ...
        this.vertexShader("opengl/endgame/dat/endgame.vs");
        this.fragmentShader("opengl/endgame/dat/endgame.fs");
        this.link();
        this.initVertex();
    ...
    private void initVertex(){
        ...
        Object[] dataInput = objLoad.Wavefront(endgame.class.getClassLoader().getResourceAsStream("opengl/endgame/dat/endgame.obj"), 1.0f, 1.0f, 1.0f);
